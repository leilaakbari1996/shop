...
<body>
<div class="wrapper-wide" dir="rtl">
  <div id="header">
    <!-- Top Bar Start-->
        ...
        <div class="table-container">
          ...
          <div class="col-table-cell col-lg-6 col-md-6 col-sm-12 col-xs-12 inner">
            <div id="logo"><a href="index.html"><img class="img-responsive"
                src="/client/image/logo.png" title="MarketShop" alt="MarketShop" /></a></div>
          </div>
          <!-- Logo End -->
          <!-- Mini Cart Start-->
                      ...
                      <tr>
                        <td class="text-center"><a href="product.html">
                            <img class="img-thumbnail" title="کفش راحتی مردانه"
                             alt="کفش راحتی مردانه" src="client/image/product/sony_vaio_1-50x50.jpg"></a></td>
